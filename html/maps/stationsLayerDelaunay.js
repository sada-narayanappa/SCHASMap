var stationLayerDelaunay = function(){
}

stationLayerDelaunay.prototype.layer    = null;
stationLayerDelaunay.prototype.features = null;
stationLayerDelaunay.prototype.map      = null;
stationLayerDelaunay.prototype.bounds   = null;

stationLayerDelaunay.prototype.AddLayer = function(map) {
   $self = this;
   this.map = map;
...
stationLayerDelaunay.prototype.AddFeatures = function (data, zoomToBounds){
   lyr = this.layer;
   eval(data);
   var locs = $rs["rows"]
...
stationLayerDelaunay.prototype.LayerUpdate = function() {
