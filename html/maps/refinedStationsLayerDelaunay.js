var refinedStationLayerDelaunay = function(){
}

refinedStationLayerDelaunay.prototype.layer    = null;
refinedStationLayerDelaunay.prototype.features = null;
refinedStationLayerDelaunay.prototype.map      = null;
refinedStationLayerDelaunay.prototype.bounds   = null;

refinedStationLayerDelaunay.prototype.AddLayer = function(map) {
   $self = this;
   this.map = map;
   ...
   var layer = new OpenLayers.Layer.Vector('Refined Delaunay', {
...
refinedStationLayerDelaunay.prototype.AddFeatures = function (data, zoomToBounds){
   lyr = this.layer;
   eval(data);
   var locs = $rs["rows"]
...
refinedStationLayerDelaunay.prototype.LayerUpdate = function() {
